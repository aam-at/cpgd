...
from utils import (compute_norms, log_metrics, register_experiment_flags,
...
flags.DEFINE_float("carlini_ub", 1e5, "upper bound for carlini C")
...
def main(unused_args):
    ...
    setup_experiment("pytorch_trades_carlini_test")
    ...
    # models
    num_classes = 10
    classifier = TradesCNN(num_classes)
