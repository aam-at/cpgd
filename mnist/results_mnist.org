...
#+BEGIN_SRC python :noweb yes
  ...
  test_params = []
  dirs = glob.glob("../results/mnist*_df")
  topk = None
  hide_result_if_not_all_adv = False
#+END_SRC

*** Plain
#+BEGIN_SRC python :noweb yes :var type="plain" :var norm="li" :results value :return df_org
  <<init_df_block>>
  <<output_results>>
#+END_SRC
...
#+BEGIN_SRC python :noweb yes
  ...
  test_params = []
  dirs = glob.glob("../results/mnist*_cw")
#+END_SRC
...
#+BEGIN_SRC python :noweb yes
  ...
  test_params = []
  dirs = glob.glob("../results/mnist*_ead")
  topk = None
#+END_SRC

*** Plain
#+BEGIN_SRC python :noweb yes :var type="plain" :var norm="l1" :results value :return df_org
  <<init_ead_block>>
  <<output_results>>
#+END_SRC

*** Linf
#+BEGIN_SRC python :noweb yes :var type="linf" :var norm="l1" :results value :return df_org
  <<init_ead_block>>
  <<output_results>>
#+END_SRC

*** L1
#+BEGIN_SRC python :noweb yes :var type="l1" :var norm="l1" :results value :return df_org
  <<init_ead_block>>
  <<output_results>>
#+END_SRC
